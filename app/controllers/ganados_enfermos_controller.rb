...
before_filter :require_usuario
  ...
  def lista
    ...
    if cond.size > 0
      ...
      @ganados_enfermos =  VGanadoEnfermo.orden_estado_enfermedad.where(cond).paginate(per_page: 10, page: params[:page])
      @total_encontrados = VGanadoEnfermo.where(cond).count

    else
     
      @ganados_enfermos = VGanadoEnfermo.orden_estado_enfermedad.paginate(per_page: 10, page: params[:page])
